    ...
    <ErrorBoundary>
      ...
      <div className={styles["settings"]}>
        <List>
          <ListItem title={Locale.Settings.Avatar}>
            {!config.isShowAvatar ? (
              ...
              <Popover
                ...
                content={
                  <UploadAvatar avatarUrl={config.avatarUrl}></UploadAvatar>
                }
          ...
          {/* 切换头像功能 */}
          <ListItem
            title={Locale.Settings.SwitchShowAvatar.Title}
            subTitle={Locale.Settings.SwitchShowAvatar.SubTitle}
          >
            <div>
              <Switch
                style={{ background: "rgb(29, 147, 171)" }}
                checkedChildren="头像"
                unCheckedChildren="表情"
                checked={config.isShowAvatar}
                onClick={(isShowAvatar) => {
                  updateConfig(
                    (config) => (config.isShowAvatar = isShowAvatar),
                  );
                }}
              />
            </div>
