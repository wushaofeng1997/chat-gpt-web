import styles from "./rain-bros.module.scss";

export function RainBros() {
  return (
    <div className={styles["rain-bros-body"]}>
      <div className={`${styles["holder"]}`}>
        <div className={`${styles["viewport"]}`}>
          <div className={`${styles["subviewport"]} ${styles["expl"]}`}>
            <div className={`${styles["explosion"]}`}>
              <div className={`${styles["explosion-circle"]}`}></div>
            </div>
          </div>
          <div className={`${styles["subviewport"]} ${styles["red"]}`}>
          ...
          <div className={`${styles["hexagon"]} ${styles["dude"]}`}>
            <div className={`${styles["face"]}`}> </div>
          </div>

          <div className={`${styles["subviewport"]} ${styles["orange"]}`}>
            <div className={`${styles["circles"]}`}>
              <div className={`${styles["circle-top"]}`}> </div>
              <div className={`${styles["circle-top"]}`}> </div>
              <div className={`${styles["circle-top"]}`}></div>
          ...
          <div className={`${styles["box"]} ${styles["dude"]}`}>
            <div className={`${styles["face"]}`}></div>
          </div>

          <div className={`${styles["subviewport"]} ${styles["green"]}`}>
            <div className={`${styles["circles"]}`}>
              <div className={`${styles["circle-top"]}`}> </div>
              <div className={`${styles["circle-top"]}`}> </div>
              <div className={`${styles["circle-top"]}`}></div>
          ...
          <div className={`${styles["rectangle"]} ${styles["dude"]}`}>
            <div className={`${styles["face"]}`}> </div>
          </div>

          <div className={`${styles["subviewport"]} ${styles["blue"]}`}>
            <div className={`${styles["circles"]}`}>
              <div className={`${styles["circle-top"]}`}> </div>
              <div className={`${styles["circle-top"]}`}> </div>
              <div className={`${styles["circle-top"]}`}></div>
          ...
          <div className={`${styles["circle"]} ${styles["dude"]}`}>
            <div className={`${styles["face"]}`}> </div>
          </div>
        </div>
      </div>
